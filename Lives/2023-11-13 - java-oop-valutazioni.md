...
Classe `Main` con metodo main in cui create un array di **20 studenti**, lo popolate con `id` studente progressivo (da 1 a 20), percentuale assenze e media voti generati random. 
