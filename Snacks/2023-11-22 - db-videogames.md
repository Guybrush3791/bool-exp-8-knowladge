...
I **videogames** possono essere disponibili su *diverse piattaforme* (PlayStation 4, PlayStation 5, XBox One, XBox Serie X, Windows, Nintendo Switch, Google Stadia, ...) e hanno *diverse categorie* (avventura, strategia, RPG, sparatutto, calcio, ...) e *classificazioni* (PEGI 7, PEGI 12, PEGI 18, Violenza, Paura, Gioco d'azzardo, ...)
...
I **videogames** possono essere recensiti dai **giocatori**, i quali oltre che con il *titolo* e il *testo*, possono valutare i videogame con un *rating da 1 a 5*.
...
## Soluzione
![[Pasted image 20231123095512.png]]