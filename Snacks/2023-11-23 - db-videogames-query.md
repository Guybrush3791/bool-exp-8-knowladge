...
## Database
[[2023-11-23 - DB Videogame|DB Videogame]]
...
```sql
SELECT software_houses.name 'softwareHouseName', awards.name 'awardName'
FROM software_houses
    JOIN videogames
...
8. Selezionare le città in cui e' stato giocato il gioco dell'anno del 2018 (36)
```sql
